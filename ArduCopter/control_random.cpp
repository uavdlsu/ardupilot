...
/*
 * Init and run calls for random flight mode
 */

// random_init - initialise random controller
bool Copter::random_init(bool ignore_checks)
{
...
// random_run - runs the main random controller
// should be called at 100hz or more
void Copter::random_run()
{
